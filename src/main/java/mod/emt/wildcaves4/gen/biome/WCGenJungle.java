...
public class WCGenJungle extends WorldGenerator {
    public WCGenJungle() {
    }

    @Override
    public boolean generate(World world, Random random, BlockPos pos) {
        switch (WCUtils.weightedChoice(WCConfig.WORLD_GEN.probabilityGlowcapsHumid, WCConfig.WORLD_GEN.probabilityVinesJungle, WCConfig.WORLD_GEN.probabilitySpiderWeb, WCConfig.WORLD_GEN.probabilitySkulls, WCConfig.WORLD_GEN.probabilityStalactite, 0)) {
            case 1:
