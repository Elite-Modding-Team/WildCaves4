...
public class WCGenJungle extends WorldGenerator {
    ...
    public boolean generate(World world, Random random, BlockPos pos) {
        switch (WCUtils.weightedChoice(WCWorldGen.probabilityGlowcapsHumid, WCWorldGen.probabilityVinesJungle, WCWorldGen.probabilitySpiderWeb, WCWorldGen.probabilitySkulls, WCWorldGen.probabilityStalactite, 0)) {
            case 1:
